          ...
          <div className="relative">
            <div className="relative h-[300px] sm:h-[400px] md:h-[500px] lg:h-[600px] overflow-hidden">
              ...
              <div className="absolute inset-0 z-20 flex flex-col justify-center p-4 md:p-8 max-w-full md:max-w-2xl">
                ...
                <p className="text-lg md:text-xl font-semibold mb-6">CHF 59.90</p>
            ...
            <div className="p-4 sm:p-6 md:p-8">
              ...
              <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-2 sm:gap-4">
                <Card className="bg-card rounded-[7px]">
                  <Image
                    alt="Game 1"
                ...
                <Card className="bg-card">
                  <Image
                    ...
                    width={200}
                    height={300}
                    className="w-full h-36 sm:h-48 object-cover rounded-[7px]"
                  />
                  <CardContent className="p-3">
                    <p className="text-sm text-muted-foreground">Base Game</p>
                ...
                <Card className="bg-card">
                  <Image
                    alt="Game 3"
                    src="/images/EGSOctopusInsomniacGamesNixxesSoftwareS21200x1600-5831c61378872a1fe233b295fbf3140f?resize=1&w=360&h=480&quality=medium.EGS_Octopus_InsomniacGamesNixxesSoftware_S2_1200x1600-5831c61378872a1fe233b295fbf3140f?resize=1&w=360&h=480&quality=medium"
                    width={200}
                    height={300}
                    className="w-full h-36 sm:h-48 object-cover rounded-[7px]"
                  />
                  <CardContent className="p-3">
                    <p className="text-sm text-muted-foreground">Base Game</p>
                    <h3 className="text-sm font-semibold">Marvel&apos;s Spider-Man-2</h3>
